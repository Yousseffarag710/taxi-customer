...
class CompletedRideScreen extends StatelessWidget {
  ...
  Widget completedRideWidgets(
      BuildContext context, RideData data, CompletedRideController controller) {
    return InkWell(
      onTap: () async {
                          ...
                          InkWell(
                              onTap: () {
                                Get.to(ConversationScreen(), arguments: {
                                  'receiverId':
                                      int.parse(data.idConducteur!.toString()),
                ...
                children: [
                  Expanded(
                      child: ButtonThem.buildButton(context,
                          btnHeight: 40,
                          title:
                              data.statutPaiement == "yes" ? "Paid" : "Pay Now",
                    ...
                    if (data.statutPaiement == "yes") {
                      ...
                      var isDone =
                          await Get.to(const TripHistoryScreen(), arguments: {
                        "rideData": data,
                      });
                      if (isDone != null) {
                        controller.getCompletedRide();
