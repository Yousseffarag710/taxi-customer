                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  "${Constant.currency.toString()} ${walletController.walletAmount.toStringAsFixed(int.parse(Constant.decimal ?? "2"))}",
          ...
          child: Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    "${Constant.currency.toString()}${double.parse(data.amount.toString()).toStringAsFixed(int.parse(Constant.decimal ?? "2"))}",
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      "${data.deductionType == 1 ? "+" : "-"} ${Constant.currency.toString()} ${double.parse(data.amount.toString()).toStringAsFixed(decimal)}",
                                      style: TextStyle(
                                        fontWeight: FontWeight.w600,
